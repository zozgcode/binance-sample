import { FatherMotherWithdrawalTxData } from "@/components/accounts/transactionData/TrxData";
import React from "react";

export default function FatherMotherWithdrawal() {
  const top7Data = FatherMotherWithdrawalTxData.slice(0, 10); // Fetching only the first five transactions
  const moreThanSeven = FatherMotherWithdrawalTxData.length > 10;
